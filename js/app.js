...
const PLANS = {
  ...
  bundle:   { label:'포맷 + 최적화',    name:'포맷 + 최적화 서비스',     price:89000, desc:'클린 포맷 후 자체 프로그램으로 최적화까지. 가장 확실한 성능 향상.', features:['Lite 포맷 전체 포함','Windows 최적화 전체 포함','자체 개발 툴 심층 적용','게임·업무 환경 최적화'] },
  dualopt:  { label:'듀얼부팅 + 최적화', name:'듀얼부팅 + 최적화 서비스', price:149000, desc:'듀얼부팅 구성 후 자체 프로그램으로 최적화까지. 게임·업무 공간을 완전히 분리하고 성능도 극대화합니다.', features:['듀얼부팅 전체 포함','Windows 최적화 전체 포함','자체 개발 툴 심층 적용','게임·업무 완전 분리 + 최적화'] },
};
