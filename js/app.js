...
const PLANS = {
  ...
  lite:     { label:'Lite 포맷',        name:'Lite 포맷 서비스',         price:45000, desc:'불필요한 요소를 제거한 트윅 설치. 순정보다 가볍고 빠른 체감을 원하는 분께 적합합니다.', features:['윈도우 트윅 설치','드라이버 기본 세팅','불필요 앱 제거','부팅 속도 개선'] },
  optimize: { label:'Windows 최적화',   name:'Windows 최적화 서비스',    price:45000, desc:'자체 개발 프로그램으로 윈도우 셋팅을 최적화합니다. 포맷 없이 진행 가능.', features:['자체 개발 툴 적용','키보드 레지스트리 설정','불필요 서비스·파일 제거','잔렉·스터터링 제거','게임별 맞춤 세팅'] },
  bundle:   { label:'포맷 + 최적화',    name:'포맷 + 최적화 서비스',     price:79000, desc:'클린 포맷 후 자체 프로그램으로 최적화까지. 가장 확실한 성능 향상.', features:['Lite 포맷 전체 포함','Windows 최적화 전체 포함','자체 개발 툴 심층 적용','게임·업무 환경 최적화'] },
  dualopt:  { label:'듀얼부팅 + 최적화', name:'듀얼부팅 + 최적화 서비스', price:139000, desc:'듀얼부팅 구성 후 자체 프로그램으로 최적화까지. 게임·업무 공간을 완전히 분리하고 성능도 극대화합니다.', features:['듀얼부팅 전체 포함','Windows 최적화 전체 포함','자체 개발 툴 심층 적용','게임·업무 완전 분리 + 최적화'] },
};
